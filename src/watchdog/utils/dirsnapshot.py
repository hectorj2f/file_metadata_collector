...
:author: yesudeep@google.com (Yesudeep Mangalapilly) and Hector Fernandez
...
class DirectorySnapshotDiff(object):
    ...
    @property
    def files_accessed(self):
        """List of files that were accessed."""
        return self._files_accessed
